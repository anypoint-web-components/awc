...
import MultiSelectableElement from "./MultiSelectableElement.js";
...
export default class MenuElement extends MultiSelectableElement {
  /**
  ...
  @state() __focusedItem: HTMLElement | undefined;
  ...
  constructor() {
    ...
    this.addEventListener('childrenchange', this._onItemsChanged.bind(this));
  }
