...
export default class FitElement extends ResizableElement {
  /**
   * The element to fit `this` into.
   */
  @property({ type: Object }) fitInto: HTMLElement | Window = window;
   ...
   */
  @property({ type: Object }) sizingTarget: HTMLElement = this;
