...
import { FitMixin } from './FitMixin.js';
import { ResizableMixin } from './ResizableMixin.js';
...
const mxFunction = base => {
  class OverlayMixinImpl extends FitMixin(ResizableMixin(base)) {
    ...
    /**
     * @return {EventListener} Previously registered handler for `opened-changed` event
     */
    get onopenedchanged() {
    ...
    /**
     * @return {EventListener} Previously registered handler for `overlay-canceled` event
     */
    ...
    /**
     * @return {EventListener} Previously registered handler for `overlay-opened` event
     */
    get onoverlayopened() {
    ...
    /**
     * @return {EventListener} Previously registered handler for `overlay-closed` event
     */
    get onoverlayclosed() {
 ...
 * @mixin
 */
export const OverlayMixin = dedupeMixin(mxFunction);
