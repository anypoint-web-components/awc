...
import { ChipSuggestion, ChipItem } from '../src/types.js';
...
class ComponentDemoPage extends DemoPage {
  ...
  @demoProperty()
  demoAllowedOnly = false;

  @demoProperty()
  demoSuggestions = false;
  ...
  auto4Out = ['activity-1', 'activity-2'];

  auto5Out = ['Biking', 'Shopping'];

  predefinedChips: ChipItem[] = [
    {
      label: 'Chip #1'
    },
    {
  ...
  iconSuggestions: ChipSuggestion[] = [{
    value: 'Biking',
  ...
  allowedChips: string[] = ['apple', 'Orange', 'BANANA'];

  idSuggestions: ChipSuggestion[] = [{
    value: 'Biking',
    icon: mapIcons.directionsBike,
    id: 'activity-1'
  }, {
