...
@customElement('x-resizer-parent-filtered')
export class XResizerParentFiltered extends ResizableElement {
...
export class XShadowResizable extends ObserveResizeMixin(ResizableElement) {
  render(): TemplateResult {
...
export class XLightResizable extends ObserveResizeMixin(ResizableElement) {
  render(): TemplateResult {
    return html`
