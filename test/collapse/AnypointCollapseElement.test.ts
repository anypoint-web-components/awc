...
describe('AnypointCollapseElement', () => {
  ...
  async function emptyFixture(): Promise<AnypointCollapseElement> {
    return fixture(html`<anypoint-collapse opened></anypoint-collapse>`);
  }

  async function horizontalFixture(): Promise<AnypointCollapseElement> {
  ...
  describe('a11y', () => {
    async function a11yFixture(): Promise<AnypointCollapseElement> {
